import{b as v,r as _,G as D,j as e,P as T,C as p,i as y,k as f,o as g,B as c,f as r}from"./index-BPP-_OMN.js";import{u as l}from"./useMutation-CMiQkM4s.js";import{I as q}from"./input-DXyqFpUo.js";import{T as z,a as C,b as u,c as d,d as N,e as s}from"./table-C5y0xJGn.js";function M(){const{data:m}=v(),n=(m==null?void 0:m.organizationId)??null,[o,x]=_.useState(""),i=D({queryKey:["tenant-domains",n],enabled:!!n,queryFn:async()=>{const t=await r({query:`query TenantDomains($organizationId: uuid!) {
...
//# sourceMappingURL=AdminTenantDomains-olttsrBd.js.map

import{b as M,w,r as c,j as e,C as z,i as N,k,o as $,B as p,F as o}from"./index-CXW08ga6.js";import{u}from"./useMutation-mXVxaFfD.js";import{C as q}from"./checkbox-e0BWYLYy.js";import{I as m}from"./input-DQ0nv64R.js";import{T as E}from"./textarea-MrBTA2MH.js";import{T as B,a as O,b as g,c as _,d as F,e as l}from"./table-8A_DMF1g.js";const D=[{id:"google",label:"Google Workspace"},{id:"azuread",label:"Azure AD"},{id:"clever",label:"Clever"},{id:"classlink",label:"ClassLink"},{id:"okta",label:"Okta"},{id:"saml",label:"SAML"}];function L(i){try{return i?JSON.parse(i):{}}catch{return{}}}function U(){const{data:i}=M(),s=(i==null?void 0:i.organizationId)??null,r=w({queryKey:["tenant-domains",s],enabled:!!s,queryFn:async()=>{const n=await o(`query TenantDomains($organizationId: uuid!) {

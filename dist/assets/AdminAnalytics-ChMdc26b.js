import{b as G,r as x,w as _,j as e,B as j,C as v,i as f,k as N,o as g,n as X,e as Y,F}from"./index-CXW08ga6.js";import{I as U}from"./input-DQ0nv64R.js";import{S as B,a as M,b as O,c as z,d as b}from"./select-CevpuT8Q.js";function V(s){return s?s.slice(0,10):null}function Q(s,n,w="text/plain"){const r=new Blob([n],{type:w}),p=URL.createObjectURL(r),h=document.createElement("a");h.href=p,h.download=s,h.click(),URL.revokeObjectURL(p)}function i(s){const n=String(s??"");return/[\n\r,\"]/g.test(n)?`"${n.replaceAll('"','""')}"`:n}function ae(){var E,A,D,q,L,T,k,R;const{data:s}=G(),[n,w]=x.useState(()=>{const t=new Date;return t.setDate(t.getDate()-14),t.toISOString().slice(0,10)}),[r,p]=x.useState(()=>new Date().toISOString().slice(0,10)),[h,K]=x.useState("all"),[y,P]=x.useState("all"),[d,S]=x.useState(null),I=_({queryKey:["analytics-ai-token"],queryFn:async()=>{const t=await X.auth.getAccessToken();return{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}}}}),u=_({queryKey:["analytics-ai-usage-summary"],enabled:!!I.data,queryFn:async()=>{const t=await fetch(`${Y}/admin/ai/usage-summary`,{headers:I.data});if(!t.ok)throw new Error("Failed to load AI usage summary");return t.json()}}),C=x.useMemo(()=>{const t={day:{_gte:n,_lte:r}};return s!=null&&s.districtId&&(t.district_id={_eq:s.districtId}),s!=null&&s.schoolId&&(t.school_id={_eq:s.schoolId}),h!=="all"&&(t.event_name={_eq:h}),t},[n,r,s==null?void 0:s.districtId,s==null?void 0:s.schoolId,h]),c=_({queryKey:["analytics-rollups",C],enabled:!!(s!=null&&s.districtId),queryFn:async()=>{const t=await F(`query Rollups($where: analytics_event_rollups_daily_bool_exp!) {

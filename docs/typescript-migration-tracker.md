...
Generated: 2026-05-07T08:43:01.473Z
...
| --- | ---: | ---: | --- | --- | --- | --- | --- |
| backend/orchestrator | 5 | 33 | P0 | Backend Platform DRI | Schemas, state/store contracts, and engine coordination remain runtime JavaScript. | Convert schema and pure state helpers before stores and engine. | 0 runtime JS files outside reviewed shims; backend typecheck covers migrated modules. |

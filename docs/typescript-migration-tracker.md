...
Generated: 2026-05-07T08:48:16.274Z
...
| --- | ---: | ---: | --- | --- | --- | --- | --- |
| backend/orchestrator | 2 | 37 | P0 | Backend Platform DRI | Schemas, state/store contracts, and engine coordination remain runtime JavaScript. | Convert schema and pure state helpers before stores and engine. | 0 runtime JS files outside reviewed shims; backend typecheck covers migrated modules. |

...
| 6. Static quality | Controlled/Improved | Typecheck, TS ratchet, full Vitest, root backend Jest, backend package Jest, lint ratchet, build, launch checks, and bundle-size ratchet pass. Lint debt is capped at 936 problems with parser and `no-undef` held at zero. Bundle ratchet tightened to 596 kB total / 23 kB initial / 214 kB largest chunk. | Full lint cleanup and deeper bundle budget decision require owner approval/remediation. |

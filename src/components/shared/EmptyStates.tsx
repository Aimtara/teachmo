...
export const EmptyDashboard = ({ onAddChild }: { onAddChild: () => void }) => (
  <EmptyState
    icon={Heart}
...
export const EmptyCalendar = ({ onPlanActivity }: { onPlanActivity: () => void }) => (
  <EmptyState
    icon={Calendar}
    ...
    actions={[
      ...
      },
      {
        ...
        icon: Sparkles,
        onClick: () => {
          window.location.href = createPageUrl('UnifiedDiscover');
        },
        variant: 'outline',
      },
    ]}
...
export const EmptyMessages = ({ userRole }: { userRole: string }) => (
  <EmptyState
    icon={MessageSquare}
    ...
    actions={[
      {
        ...
        icon: Users,
        onClick: () => {
          window.location.href = createPageUrl(userRole === 'parent' ? 'Messages' : 'TeacherClasses');
        },
        showArrow: true,
      },
    ]}
...
export const EmptyLibrary = ({ onExplore }: { onExplore: () => void }) => (
  <EmptyState
    icon={BookOpen}
